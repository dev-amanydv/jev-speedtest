...
export function BenchmarkSidebar({
  ...
  return (
    <aside className="w-full md:w-1/3 flex flex-col justify-between p-6 md:p-8 md:pr-10 border-b md:border-b-0 md:border-r border-neutral-200">
      {/* Top benchmark content */}
